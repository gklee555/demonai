      ...
      // separate states (loops) and emotes ( 1 time)
        ...
        console.log("Number of animations: " + animations.length);
				...
				var expressions = Object.keys( cube.morphTargetDictionary );
				var expressionFolder = gui.addFolder('Expressions');

				for ( var i = 0; i < expressions.length; i++ ) {

					expressionFolder.add( cube.morphTargetInfluences, i, 0, 1 ).name( expressions[ i ] );

				}

				activeAction = actions['FirstAnim'];
				activeAction.play();
